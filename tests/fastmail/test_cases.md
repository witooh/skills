...
1. Execute: `bun scripts/cli.ts list_mailboxes`
...
1. Execute: `bun scripts/cli.ts list_emails '{"limit": 5}'`
...
2. Execute: `bun scripts/cli.ts list_emails '{"mailbox_id": "SENT_ID", "limit": 10}'`
...
2. Execute: `bun scripts/cli.ts get_email '{"email_id": "EMAIL_ID"}'`
...
2. Execute: `bun scripts/cli.ts get_thread '{"email_id": "THREAD_EMAIL_ID"}'`
...
1. Execute: `bun scripts/cli.ts search_emails '{"query": "test", "limit": 20}'`
...
1. Execute: `bun scripts/cli.ts search_emails '{"query": "XYZ_NONEXISTENT_12345"}'`
...
1. Execute: `bun scripts/cli.ts send_email '{"to": [{"email": "test@example.com"}], "subject": "Test Email", "body": "This is a test email"}'`
...
1. Execute: `bun scripts/cli.ts send_email '{"to": [{"name": "User1", "email": "user1@test.com"}, {"email": "user2@test.com"}], "cc": [{"email": "cc@test.com"}], "subject": "Multi-recipient Test", "body": "Test with multiple recipients"}'`
...
1. Execute: `bun scripts/cli.ts send_email '{"to": [{"email": "test@example.com"}], "subject": "HTML Test", "body": "Plain text fallback", "html": "<h1>HTML Email</h1><p>Formatted content</p>"}'`
...
1. Execute: `bun scripts/cli.ts reply_email '{"email_id": "EMAIL_ID", "body": "Thanks for your message!"}'`
...
1. Execute: `bun scripts/cli.ts reply_email '{"email_id": "EMAIL_ID", "body": "Replying to all", "reply_all": true}'`
...
1. Execute: `bun scripts/cli.ts move_email '{"email_id": "EMAIL_ID", "target_mailbox_id": "ARCHIVE_ID"}'`
...
1. Execute: `bun scripts/cli.ts set_labels '{"email_id": "EMAIL_ID", "labels": {"$seen": true}}'`
...
1. Execute: `bun scripts/cli.ts set_labels '{"email_id": "EMAIL_ID", "labels": {"$flagged": true, "Important": true}}'`
...
1. Execute: `bun scripts/cli.ts delete_email '{"email_id": "EMAIL_ID"}'`
...
1. Execute: `bun scripts/cli.ts bulk_move_emails '{"email_ids": ["id1", "id2", "id3"], "target_mailbox_id": "TARGET_ID"}'`
...
1. Execute: `bun scripts/cli.ts bulk_set_labels '{"email_ids": ["id1", "id2"], "labels": {"$seen": true}}'`
...
1. Execute: `bun scripts/cli.ts bulk_delete_emails '{"email_ids": ["id1", "id2", "id3"]}'`
...
1. Execute: `bun scripts/cli.ts list_calendars`
...
1. Execute: `bun scripts/cli.ts list_events '{"start_date": "2026-01-01", "end_date": "2026-01-31"}'`
...
1. Execute: `bun scripts/cli.ts list_events '{"calendar_id": "CAL_ID", "start_date": "2026-01-01", "end_date": "2026-01-31"}'`
...
1. Execute: `bun scripts/cli.ts get_event '{"event_id": "EVENT_ID"}'`
...
1. Execute: `bun scripts/cli.ts create_event '{"title": "Test Meeting", "start": "2026-02-15T10:00:00", "end": "2026-02-15T11:00:00"}'`
...
1. Execute: `bun scripts/cli.ts create_event '{"title": "Project Review", "start": "2026-02-20T14:00:00", "end": "2026-02-20T15:30:00", "description": "Quarterly review meeting", "location": "Conference Room A"}'`
...
1. Execute: `bun scripts/cli.ts create_event '{"title": "Company Holiday", "start": "2026-03-01", "end": "2026-03-02", "all_day": true}'`
...
1. Execute: `bun scripts/cli.ts update_event '{"event_id": "EVENT_ID", "title": "Updated Meeting Title", "location": "New Location"}'`
...
1. Execute: `bun scripts/cli.ts delete_event '{"event_id": "EVENT_ID"}'`
...
1. Execute: `bun scripts/cli.ts search_events '{"query": "meeting"}'`
...
1. Execute: `bun scripts/cli.ts create_recurring_event '{"title": "Daily Standup", "start": "2026-02-01T09:00:00", "end": "2026-02-01T09:30:00", "recurrence": "daily", "recurrence_count": 5}'`
...
1. Execute: `bun scripts/cli.ts create_recurring_event '{"title": "Weekly Review", "start": "2026-02-01T10:00:00", "end": "2026-02-01T11:00:00", "recurrence": "weekly", "recurrence_until": "2026-03-31"}'`
...
1. Execute: `bun scripts/cli.ts list_invitations`
...
1. Execute: `bun scripts/cli.ts respond_to_invitation '{"event_id": "EVENT_ID", "response": "accept"}'`
2. Execute: Test decline with another invitation: `bun scripts/cli.ts respond_to_invitation '{"event_id": "EVENT_ID2", "response": "decline"}'`
...
1. Execute: `bun scripts/cli.ts add_event_reminder '{"event_id": "EVENT_ID", "minutes_before": 15}'`
...
1. Execute: `bun scripts/cli.ts add_event_reminder '{"event_id": "EVENT_ID", "days_before": 1, "action": "email", "description": "Don't forget!"}'`
...
1. Remove specific: `bun scripts/cli.ts remove_event_reminder '{"event_id": "EVENT_ID", "reminder_id": "REMINDER_ID"}'`
2. Remove all: `bun scripts/cli.ts remove_event_reminder '{"event_id": "EVENT_ID"}'`
...
1. Execute: `bun scripts/cli.ts list_event_reminders '{"event_id": "EVENT_ID"}'`
...
1. Execute: `bun scripts/cli.ts create_event_with_reminder '{"title": "Important Meeting", "start": "2026-02-25T10:00:00", "end": "2026-02-25T11:00:00", "reminder_minutes": [15, 60, 1440]}'`
...
2. Execute: `bun scripts/cli.ts list_mailboxes`
...
3. Execute: `bun scripts/cli.ts list_calendars`
...
2. Execute: `bun scripts/cli.ts list_calendars`
...
2. Execute: `bun scripts/cli.ts list_events '{"start_date": "2026-01-01", "end_date": "2026-01-31"}'`
...
1. Execute: `bun scripts/cli.ts --help`
...
1. Execute: `bun scripts/cli.ts --list`
