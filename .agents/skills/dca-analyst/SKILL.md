...
4. **Technical analysis (daily + weekly)**
   ...
   - **For ETFs on investing.com**:
     ...
     - **MUST CAPTURE** (in order of priority):
       ...
       4. **Pivot Points** (REQUIRED for buy levels):
          - Classic Pivot Point (P)
          - Support levels (S1, S2, S3) - used as recommended buy price levels
          - Resistance levels (R1, R2, R3) - used as price targets
...
### 🎯 ระดับราคาซื้อที่แนะนำ (Recommended Buy Levels)
| สินทรัพย์ | ราคาปัจจุบัน | ระดับ 1 (ซื้อทันที) | ระดับ 2 (ซื้อเสริม) | ระดับ 3 (ซื้อหนัก) | Stop Loss |
|---------|------------|-------------------|-------------------|-------------------|----------|
| SMH | $XXX | $XXX (S1) | $XXX (S2) | $XXX (S3) | $XXX |
| QQQM | $XXX | $XXX (S1) | $XXX (S2) | $XXX (S3) | $XXX |

### 📋 กลยุทธ์การซื้อ (Buying Strategy)
**กลยุทธ์หลัก**: RSI-Adjusted DCA + Pivot Support Levels

| ระดับราคา | % ของเงินลงทุน | เงื่อนไข |
|----------|--------------|--------|
| ราคาปัจจุบัน | 40% | ซื้อทันทีตาม RSI signal |
| ถึง S1 | +30% | เพิ่มเมื่อถึงแนวรับแรก |
| ถึง S2 | +20% | เพิ่มเมื่อถึงแนวรับสอง |
| ถึง S3 | +10% | เพิ่มเมื่อถึงแนวรับสาม (ถัวเฉลี่ยหนัก) |
...
## ระดับราคาซื้อที่แนะนำ (Recommended Buy Levels)
| สัญลักษณ์ | ราคาปัจจุบัน | S1 (แนวรับ 1) | S2 (แนวรับ 2) | S3 (แนวรับ 3) | Stop Loss | ที่มา |
|----------|------------|--------------|--------------|--------------|-----------|------|
| XXX | $XX.XX | $XX.XX | $XX.XX | $XX.XX | $XX.XX | Pivot Points |

## กลยุทธ์การซื้อ (Buying Strategy)
### สินทรัพย์ 1: XXX
- **กลยุทธ์**: [RSI-Adjusted / Value Averaging / Volatility-Based]
- **แผนการซื้อ**:
  1. ซื้อ XX% ของเงินลงทุนที่ราคาปัจจุบัน (RSI signal)
  2. ซื้อเพิ่ม XX% ถ้าราคาลงมาถึง S1 ($XX.XX)
  3. ซื้อเพิ่ม XX% ถ้าราคาลงมาถึง S2 ($XX.XX)
- **Stop Loss**: $XX.XX (ต่ำกว่า S3 ประมาณ 3-5%)
- **เหตุผล**: [อธิบายเหตุผลจาก technical signals]
...
## Recommended Buy Levels (ระดับราคาซื้อที่แนะนำ)
| Asset | Current | Level 1 (Buy Now) | Level 2 (Add More) | Level 3 (Heavy Buy) | Stop Loss |
|-------|---------|-------------------|--------------------|--------------------|----------|
| XXX | $XX.XX | $XX.XX | $XX.XX | $XX.XX | $XX.XX |

Calculation Method: [Pivot Points / Fibonacci / MA levels]

## Buying Strategy (กลยุทธ์การซื้อ)
### Asset: XXX
**Strategy Type**: [RSI-Adjusted / Value Averaging / Volatility-Based]

**Execution Plan**:
| Price Level | % of Budget | Condition | Multiplier |
|-------------|-------------|-----------|------------|
| Current | 40% | RSI < 50 | 1.4x |
| S1 | +30% | Price hits support | 1.6x |
| S2 | +20% | Deeper correction | 1.8x |
| S3 | +10% | Major dip | 2.0x |

**Order Types**:
- Market order: XX% at current for RSI signal
- Limit orders: Set at S1, S2, S3 levels
- Time in force: GTC (Good Till Cancelled)

**Risk Management**:
- Stop Loss: $XX.XX (X% below entry)
- Max position size: XX% of portfolio
- Trailing stop: X% (optional)
...
- [ ] **Pivot Points (S1, S2, S3)** for recommended buy levels
...
- `references/buying-strategy.md`: Buy levels calculation (Pivot Points, Fibonacci, ATR) and execution strategies
