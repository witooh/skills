...
function getLens(b64) {
  var len2 = b64.length;
  if (len2 % 4 > 0) throw Error("Invalid string. Length must be a multiple of 4");
...
function fromByteArray(uint8) {
  ...
  if (extraBytes === 1) ((tmp = uint8[len2 - 1]), parts.push(lookup[tmp >> 2] + lookup[(tmp << 4) & 63] + "=="));
...
function write(buffer, value, offset, isLE, mLen, nBytes) {
  ...
  if (((value = Math.abs(value)), isNaN(value) || value === 1 / 0)) ((m = isNaN(value) ? 1 : 0), (e = eMax));
  else {
    if (((e = Math.floor(Math.log(value) / Math.LN2)), value * (c = Math.pow(2, -e)) < 1)) (e--, (c *= 2));
...
function createBuffer(length) {
  if (length > kMaxLength) throw RangeError('The value "' + length + '" is invalid for option "size"');
...
function assertSize(size) {
  ...
  else if (size < 0) throw RangeError('The value "' + size + '" is invalid for option "size"');
}
...
function fromString(string, encoding) {
  ...
  if (!Buffer2.isEncoding(encoding)) throw TypeError("Unknown encoding: " + encoding);
...
function fromObject(obj) {
  ...
  if (obj.length !== undefined) {
    if (typeof obj.length !== "number" || Number.isNaN(obj.length)) return createBuffer(0);
...
function bidirectionalIndexOf(buffer, val, byteOffset, encoding, dir) {
  ...
  if (((byteOffset = +byteOffset), Number.isNaN(byteOffset))) byteOffset = dir ? 0 : buffer.length - 1;
      ...
      switch (bytesPerSequence) {
        ...
        case 3:
          if (
            ...
            if (
              ...
              tempCodePoint > 2047 && (tempCodePoint < 55296 || tempCodePoint > 57343))
            )
              codePoint = tempCodePoint;
          }
          break;
        case 4:
          if (
            ...
            (thirdByte = buf[i2 + 2]),
            (fourthByte = buf[i2 + 3]),
            (secondByte & 192) === 128 && (thirdByte & 192) === 128 && (fourthByte & 192) === 128)
          ) {
            if (
              ((tempCodePoint =
...
function decodeCodePointsArray(codePoints) {
  ...
  if (len2 <= MAX_ARGUMENTS_LENGTH) return String.fromCharCode.apply(String, codePoints);
  let res = "",
    i2 = 0;
  while (i2 < len2) res += String.fromCharCode.apply(String, codePoints.slice(i2, (i2 += MAX_ARGUMENTS_LENGTH)));
  return res;
}
function asciiSlice(buf, start, end) {
  let ret = "";
  end = Math.min(buf.length, end);
  for (let i2 = start; i2 < end; ++i2) ret += String.fromCharCode(buf[i2] & 127);
  return ret;
}
...
function utf16leSlice(buf, start, end) {
  let bytes = buf.slice(start, end),
    res = "";
  for (let i2 = 0; i2 < bytes.length - 1; i2 += 2) res += String.fromCharCode(bytes[i2] + bytes[i2 + 1] * 256);
  return res;
}
...
function checkInt(buf, value, offset, ext, max, min) {
  if (!Buffer2.isBuffer(buf)) throw TypeError('"buffer" argument must be a Buffer instance');
...
function asciiToBytes(str) {
  let byteArray = [];
  for (let i2 = 0; i2 < str.length; ++i2) byteArray.push(str.charCodeAt(i2) & 255);
  return byteArray;
}
...
var lookup,
  ...
  isUtf8,
  isAscii = (str) => {
    for (let char of str) if (char.charCodeAt(0) > 127) return false;
    return true;
  },
  transcode,
  buffer_default;
var init_buffer = __esm(() => {
  lookup = [];
  revLookup = [];
  for (i = 0, len = code.length; i < len; ++i) ((lookup[i] = code[i]), (revLookup[code.charCodeAt(i)] = i));
  revLookup[45] = 62;
  revLookup[95] = 63;
  customInspectSymbol =
  ...
  ERR_OUT_OF_RANGE = E(
    ...
    function (str, range, input) {
      let msg = `The value of "${str}" is out of range.`,
        received = input;
      if (Number.isInteger(input) && Math.abs(input) > 4294967296) received = addNumericalSeparator(String(input));
  ...
  Buffer2.concat = function (list, length) {
    ...
    for (i2 = 0; i2 < list.length; ++i2) {
      ...
      else if (!Buffer2.isBuffer(buf)) throw TypeError('"list" argument must be an Array of Buffers');
  ...
  Buffer2.prototype.swap16 = function () {
    ...
    if (len2 % 2 !== 0) throw RangeError("Buffer size must be a multiple of 16-bits");
    for (let i2 = 0; i2 < len2; i2 += 2) swap(this, i2, i2 + 1);
    return this;
  };
  Buffer2.prototype.swap32 = function () {
    let len2 = this.length;
    if (len2 % 4 !== 0) throw RangeError("Buffer size must be a multiple of 32-bits");
    for (let i2 = 0; i2 < len2; i2 += 4) (swap(this, i2, i2 + 3), swap(this, i2 + 1, i2 + 2));
    return this;
  };
  Buffer2.prototype.swap64 = function () {
    let len2 = this.length;
    if (len2 % 8 !== 0) throw RangeError("Buffer size must be a multiple of 64-bits");
  ...
  Buffer2.prototype.readBigUInt64LE = defineBigIntMethod(function (offset) {
    ...
    let lo = first + this[++offset] * 256 + this[++offset] * 65536 + this[++offset] * 16777216,
      hi = this[++offset] + this[++offset] * 256 + this[++offset] * 65536 + last * 16777216;
  ...
  Buffer2.prototype.readBigUInt64BE = defineBigIntMethod(function (offset) {
    ...
    let first = this[offset],
      last = this[offset + 7];
    if (first === undefined || last === undefined) boundsError(offset, this.length - 8);
    let hi = first * 16777216 + this[++offset] * 65536 + this[++offset] * 256 + this[++offset],
      lo = this[++offset] * 16777216 + this[++offset] * 65536 + this[++offset] * 256 + last;
  ...
  Buffer2.prototype.readBigInt64LE = defineBigIntMethod(function (offset) {
    ...
    return (
      ...
      BigInt(first + this[++offset] * 256 + this[++offset] * 65536 + this[++offset] * 16777216)
    );
  });
  Buffer2.prototype.readBigInt64BE = defineBigIntMethod(function (offset) {
    ...
    return (
      (BigInt(val) << BigInt(32)) +
      BigInt(this[++offset] * 16777216 + this[++offset] * 65536 + this[++offset] * 256 + last)
    );
  });
  ...
  Buffer2.prototype.writeUintLE = Buffer2.prototype.writeUIntLE = function (value, offset, byteLength2, noAssert) {
    ...
    while (++i2 < byteLength2 && (mul *= 256)) this[offset + i2] = (value / mul) & 255;
  ...
  Buffer2.prototype.writeUint8 = Buffer2.prototype.writeUInt8 = function (value, offset, noAssert) {
    if (((value = +value), (offset = offset >>> 0), !noAssert)) checkInt(this, value, offset, 1, 255, 0);
  ...
  Buffer2.prototype.writeUint16LE = Buffer2.prototype.writeUInt16LE = function (value, offset, noAssert) {
    if (((value = +value), (offset = offset >>> 0), !noAssert)) checkInt(this, value, offset, 2, 65535, 0);
  ...
  Buffer2.prototype.writeUint32LE = Buffer2.prototype.writeUInt32LE = function (value, offset, noAssert) {
    if (((value = +value), (offset = offset >>> 0), !noAssert)) checkInt(this, value, offset, 4, 4294967295, 0);
    return (
  ...
  Buffer2.prototype.writeInt8 = function (value, offset, noAssert) {
    if (((value = +value), (offset = offset >>> 0), !noAssert)) checkInt(this, value, offset, 1, 127, -128);
    if (value < 0) value = 255 + value + 1;
    return ((this[offset] = value & 255), offset + 1);
  };
  Buffer2.prototype.writeInt16LE = function (value, offset, noAssert) {
    if (((value = +value), (offset = offset >>> 0), !noAssert)) checkInt(this, value, offset, 2, 32767, -32768);
    return ((this[offset] = value & 255), (this[offset + 1] = value >>> 8), offset + 2);
  };
  ...
  hexSliceLookupTable = (function () {
    ...
    for (let i2 = 0; i2 < 16; ++i2) {
      let i16 = i2 * 16;
      for (let j = 0; j < 16; ++j) table[i16 + j] = "0123456789abcdef"[i2] + "0123456789abcdef"[j];
    }
    return table;
  })();
...
function emitError(emitter, args) {
  ...
  if (((args[0] ??= Error("Unhandled error.")), !events)) throw args[0];
  var errorMonitor = events[kErrorMonitor];
  if (errorMonitor) for (var handler of ArrayPrototypeSlice.call(errorMonitor)) handler.apply(emitter, args);
  var handlers = events.error;
  if (!handlers) throw args[0];
  for (var handler of ArrayPrototypeSlice.call(handlers)) handler.apply(emitter, args);
  return true;
}
...
function overflowWarning(emitter, type, handlers) {
  ...
  let warn = Error(
    `Possible EventEmitter memory leak detected. ${handlers.length} ${String(type)} listeners added to [${emitter.constructor.name}]. Use emitter.setMaxListeners() to increase limit`,
  );
...
function once2(emitter, type, options) {
  ...
  if (
    ...
    type !== "error" && typeof emitter.once === "function")
  )
...
function setMaxListeners2(n, ...eventTargets) {
  ...
  if (eventTargets && (length = eventTargets.length))
    for (let i2 = 0; i2 < length; i2++) eventTargets[i2].setMaxListeners(n);
  else defaultMaxListeners = n;
}
...
function eventTargetAgnosticRemoveListener(emitter, name, listener, flags) {
  ...
  else emitter.removeEventListener(name, listener, flags);
}
function eventTargetAgnosticAddListener(emitter, name, listener, flags) {
  if (typeof emitter.on === "function")
    if (flags.once) emitter.once(name, listener);
    else emitter.on(name, listener);
  else emitter.addEventListener(name, listener, flags);
}
...
function validateNumber2(value, name, min, max) {
  if (typeof value !== "number") throw ERR_INVALID_ARG_TYPE2(name, "number", value);
  if (
    (min != null && value < min) ||
    (max != null && value > max) ||
...
function checkListener(listener) {
  if (typeof listener !== "function") throw TypeError("The listener must be a function");
}
function validateBoolean(value, name) {
  if (typeof value !== "boolean") throw ERR_INVALID_ARG_TYPE2(name, "boolean", value);
}
function getMaxListeners2(emitterOrTarget) {
  return emitterOrTarget?._maxListeners ?? defaultMaxListeners;
}
function addAbortListener(signal, listener) {
  if (signal === undefined) throw ERR_INVALID_ARG_TYPE2("signal", "AbortSignal", signal);
...
var SymbolFor,
  ...
  emitWithoutRejectionCapture = function (type, ...args) {
...
var init_events = __esm(() => {
  ...
  EventEmitterPrototype.addListener = function (type, fn) {
    ...
    if (!events) ((events = this._events = { __proto__: null }), (this._eventsCount = 0));
    else if (events.newListener) this.emit("newListener", type, fn.listener ?? fn);
    var handlers = events[type];
    if (!handlers) ((events[type] = [fn]), this._eventsCount++);
    else {
      handlers.push(fn);
      var m = this._maxListeners ?? defaultMaxListeners;
      if (m > 0 && handlers.length > m && !handlers.warned) overflowWarning(this, type, handlers);
    }
    return this;
  };
  ...
  EventEmitterPrototype.removeListener = function (type, fn) {
    ...
    if (position === 0) handlers.shift();
    else handlers.splice(position, 1);
  ...
  EventEmitterPrototype.removeAllListeners = function (type) {
    var { _events: events } = this;
    if (type && events) {
      if (events[type]) (delete events[type], this._eventsCount--);
...
var require_stream = __commonJS((exports, module) => {
  ...
  var require_primordials = __commonJS2((exports2, module2) => {
    class AggregateError extends Error {
      constructor(errors) {
        if (!Array.isArray(errors)) throw TypeError(`Expected input to be an Array, got ${typeof errors}`);
        let message = "";
...
`;
  ...
  var require_errors = __commonJS2((exports2, module2) => {
    var { format, inspect } = require_inspect(),
      { AggregateError: CustomAggregateError } = require_primordials(),
      AggregateError = globalThis.AggregateError || CustomAggregateError,
      kIsNodeError = Symbol("kIsNodeError"),
      kTypes = ["string", "function", "number", "object", "Function", "Object", "boolean", "bigint", "symbol"],
    ...
    function E2(code2, message, Base) {
      ...
      (Object.defineProperties(NodeError.prototype, {
        name: { value: Base.name, writable: true, enumerable: false, configurable: true },
        toString: {
          value() {
            return `${this.name} [${code2}]: ${this.message}`;
          },
    ...
    function aggregateTwoErrors(innerError, outerError) {
      if (innerError && outerError && innerError !== outerError) {
        if (Array.isArray(outerError.errors)) return (outerError.errors.push(innerError), outerError);
      ...
      (name, expected, actual) => {
        ...
        for (let value of expected)
          if (
            ...
            kTypes.includes(value))
          )
            types.push(value.toLowerCase());
          else if (classRegExp.test(value)) instances.push(value);
          else (assert(value !== "object", 'The value "object" should be written as "Object"'), other.push(value));
        if (instances.length > 0) {
          let pos = types.indexOf("object");
          if (pos !== -1) (types.splice(types, pos, 1), instances.push("Object"));
        }
        if (types.length > 0) {
          switch (types.length) {
            case 1:
    ...
    E2(
      ...
      (str, range, input) => {
        ...
        let received;
        if (Number.isInteger(input) && Math.abs(input) > 4294967296) received = addNumericalSeparator2(String(input));
        else if (typeof input === "bigint") {
          received = String(input);
          let limit = BigInt(2) ** BigInt(32);
          if (input > limit || input < -limit) received = addNumericalSeparator2(received);
          received += "n";
  ...
  var require_event_target_shim = __commonJS2((exports2, module2) => {
    ...
    function setCancelFlag(data) {
      ...
      if (((data.canceled = true), typeof data.event.preventDefault === "function")) data.event.preventDefault();
    }
    ...
    Event.prototype = {
      ...
      stopPropagation() {
        let data = pd(this);
        if (((data.stopped = true), typeof data.event.stopPropagation === "function")) data.event.stopPropagation();
      },
      stopImmediatePropagation() {
        ...
        if (
          ...
          typeof data.event.stopImmediatePropagation === "function")
        )
      ...
      set cancelBubble(value) {
        if (!value) return;
        let data = pd(this);
        if (((data.stopped = true), typeof data.event.cancelBubble === "boolean")) data.event.cancelBubble = true;
      },
      get returnValue() {
        return !pd(this).canceled;
      },
    ...
    function getListeners(eventTarget) {
      ...
      if (listeners == null) throw TypeError("'this' is expected an EventTarget object, but got another value.");
      return listeners;
    }
    ...
    function defineCustomEventTarget(eventNames) {
      ...
      for (let i2 = 0; i2 < eventNames.length; ++i2) defineEventAttribute(CustomEventTarget.prototype, eventNames[i2]);
    ...
    function EventTarget() {
      ...
      if (arguments.length > 0) {
        ...
        for (let i2 = 0; i2 < arguments.length; ++i2) types[i2] = arguments[i2];
    ...
    EventTarget.prototype = {
      addEventListener(eventName, listener, options) {
        ...
        let listeners = getListeners(this),
          optionsIsObj = isObject(options),
          listenerType = (optionsIsObj ? Boolean(options.capture) : Boolean(options)) ? CAPTURE : BUBBLE,
          newNode = {
            listener,
            listenerType,
      ...
      removeEventListener(eventName, listener, options) {
        if (listener == null) return;
        let listeners = getListeners(this),
          listenerType = (isObject(options) ? Boolean(options.capture) : Boolean(options)) ? CAPTURE : BUBBLE,
          prev = null,
          node = listeners.get(eventName);
        while (node != null) {
      ...
      dispatchEvent(event) {
        if (event == null || typeof event.type !== "string") throw TypeError('"event.type" should be a string.');
        let listeners = getListeners(this),
          eventName = event.type,
          node = listeners.get(eventName);
        if (node == null) return true;
        let wrappedEvent = wrapEvent(this, event),
          prev = null;
        while (node != null) {
          if (node.once)
            if (prev !== null) prev.next = node.next;
          ...
          if (
            (setPassiveListener(wrappedEvent, node.passive ? node.listener : null), typeof node.listener === "function")
          )
            try {
              node.listener.call(this, wrappedEvent);
            } catch (err) {
              if (typeof console < "u" && typeof console.error === "function") console.error(err);
            }
  ...
  var require_util = __commonJS2((exports2, module2) => {
    var bufferModule = (init_buffer(), __toCommonJS(exports_buffer)),
      { format, inspect } = require_inspect(),
      {
        codes: { ERR_INVALID_ARG_TYPE: ERR_INVALID_ARG_TYPE3 },
      } = require_errors(),
      { kResistStopPropagation, AggregateError, SymbolDispose } = require_primordials(),
      AbortSignal = globalThis.AbortSignal || require_abort_controller().AbortSignal,
      AbortController2 = globalThis.AbortController || require_abort_controller().AbortController,
      AsyncFunction = Object.getPrototypeOf(async function () {}).constructor,
      Blob3 = globalThis.Blob || bufferModule.Blob,
      isBlob =
        typeof Blob3 < "u"
          ? function (b) {
      ...
      validateFunction = (value, name) => {
        if (typeof value !== "function") throw new ERR_INVALID_ARG_TYPE3(name, "Function", value);
      };
    module2.exports = {
      AggregateError,
      ...
      addAbortListener:
        (init_events(), __toCommonJS(exports_events)).addAbortListener ||
        function (signal, listener) {
          if (signal === undefined) throw new ERR_INVALID_ARG_TYPE3("signal", "AbortSignal", signal);
          ...
          return {
            ...
            [SymbolDispose]() {
              ...
              (_removeEventListener = removeEventListener) === null ||
  ...
  var require_validators = __commonJS2((exports2, module2) => {
    var {
      ...
      { normalizeEncoding } = require_util(),
      { isAsyncFunction, isArrayBufferView } = require_util().types,
      signals = {};
    ...
    var octalReg = /^[0-7]+$/,
      modeDesc = "must be a 32-bit unsigned integer or an octal string";
    function parseFileMode(value, name, def) {
      if (typeof value > "u") value = def;
      if (typeof value === "string") {
    ...
    var validateInteger = hideStackFrames((value, name, min = NumberMIN_SAFE_INTEGER, max = NumberMAX_SAFE_INTEGER) => {
        if (typeof value !== "number") throw new ERR_INVALID_ARG_TYPE3(name, "number", value);
        if (!NumberIsInteger(value)) throw new ERR_OUT_OF_RANGE3(name, "an integer", value);
        if (value < min || value > max) throw new ERR_OUT_OF_RANGE3(name, `>= ${min} && <= ${max}`, value);
      }),
      ...
      validateUint32 = hideStackFrames((value, name, positive = false) => {
        if (typeof value !== "number") throw new ERR_INVALID_ARG_TYPE3(name, "number", value);
        if (!NumberIsInteger(value)) throw new ERR_OUT_OF_RANGE3(name, "an integer", value);
        let min = positive ? 1 : 0,
          max = 4294967295;
        if (value < min || value > max) throw new ERR_OUT_OF_RANGE3(name, `>= ${min} && <= ${max}`, value);
      });
    function validateString(value, name) {
      if (typeof value !== "string") throw new ERR_INVALID_ARG_TYPE3(name, "string", value);
    }
    ...
    function validateBoolean2(value, name) {
      if (typeof value !== "boolean") throw new ERR_INVALID_ARG_TYPE3(name, "boolean", value);
    }
    function getOwnPropertyValueOrDefault(options, key, defaultValue) {
      return options == null || !ObjectPrototypeHasOwnProperty(options, key) ? defaultValue : options[key];
    }
    var validateObject = hideStackFrames((value, name, options = null) => {
        let allowArray = getOwnPropertyValueOrDefault(options, "allowArray", false),
          allowFunction = getOwnPropertyValueOrDefault(options, "allowFunction", false);
        if (
          (!getOwnPropertyValueOrDefault(options, "nullable", false) && value === null) ||
      ...
      validateArray = hideStackFrames((value, name, minLength = 0) => {
        if (!ArrayIsArray(value)) throw new ERR_INVALID_ARG_TYPE3(name, "Array", value);
    ...
    function validateStringArray(value, name) {
      ...
      for (let i2 = 0; i2 < value.length; i2++) validateString(value[i2], `${name}[${i2}]`);
    }
    function validateBooleanArray(value, name) {
      validateArray(value, name);
      for (let i2 = 0; i2 < value.length; i2++) validateBoolean2(value[i2], `${name}[${i2}]`);
    }
    function validateAbortSignalArray(value, name) {
      ...
      for (let i2 = 0; i2 < value.length; i2++) {
        let signal = value[i2],
          indexedName = `${name}[${i2}]`;
        if (signal == null) throw new ERR_INVALID_ARG_TYPE3(indexedName, "AbortSignal", signal);
    ...
    var validateAbortSignal2 = hideStackFrames((signal, name) => {
      ...
      validateUndefined = hideStackFrames((value, name) => {
        if (value !== undefined) throw new ERR_INVALID_ARG_TYPE3(name, "undefined", value);
      });
    ...
    function validateLinkHeaderValue(hints) {
      if (typeof hints === "string") return (validateLinkHeaderFormat(hints, "hints"), hints);
        ...
        for (let i2 = 0; i2 < hintsLength; i2++) {
          let link = hints[i2];
          if ((validateLinkHeaderFormat(link, "hints"), (result += link), i2 !== hintsLength - 1)) result += ", ";
        }
        return result;
      }
      throw new ERR_INVALID_ARG_VALUE(
  ...
  var require_utils = __commonJS2((exports2, module2) => {
    var { SymbolAsyncIterator, SymbolIterator, SymbolFor: SymbolFor2 } = require_primordials(),
      kIsDestroyed = SymbolFor2("nodejs.stream.destroyed"),
      kIsErrored = SymbolFor2("nodejs.stream.errored"),
      kIsReadable = SymbolFor2("nodejs.stream.readable"),
      kIsWritable = SymbolFor2("nodejs.stream.writable"),
      kIsDisturbed = SymbolFor2("nodejs.stream.disturbed"),
      kIsClosedPromise = SymbolFor2("nodejs.webstream.isClosedPromise"),
      kControllerErrorFunction = SymbolFor2("nodejs.webstream.controllerErrorFunction");
  ...
  var require_end_of_stream = __commonJS2((exports2, module2) => {
    var process2 = require_process(),
      { AbortError: AbortError2, codes } = require_errors(),
      { ERR_INVALID_ARG_TYPE: ERR_INVALID_ARG_TYPE3, ERR_STREAM_PREMATURE_CLOSE } = codes,
      { kEmptyObject, once } = require_util(),
      {
        validateAbortSignal: validateAbortSignal2,
        validateFunction,
        validateObject,
    ...
    function eos(stream, options, callback) {
      ...
      if (arguments.length === 2) ((callback = options), (options = kEmptyObject));
      ...
      if (
        ...
        isReadableStream(stream) || isWritableStream(stream))
      )
      ...
      let readable =
        ...
        onfinish = () => {
          if (((writableFinished = true), stream.destroyed)) willEmitClose = false;
          if (willEmitClose && (!stream.readable || readable)) return;
          if (!readable || readableFinished) callback.call(stream);
        },
        readableFinished = isReadableFinished(stream, false),
        onend = () => {
          if (((readableFinished = true), stream.destroyed)) willEmitClose = false;
      ...
      if (isRequest(stream)) {
        if ((stream.on("complete", onfinish), !willEmitClose)) stream.on("abort", onclose);
        if (stream.req) onrequest();
        else stream.on("request", onrequest);
      } else if (writable && !wState) (stream.on("end", onlegacyfinish), stream.on("close", onlegacyfinish));
      ...
      if ((stream.on("close", onclose), closed)) process2.nextTick(onclose);
      else if (
        (wState !== null && wState !== undefined && wState.errorEmitted) ||
        (rState !== null && rState !== undefined && rState.errorEmitted)
      ) {
        if (!willEmitClose) process2.nextTick(onclosed);
      } else if (
        !readable &&
        ...
        process2.nextTick(onclosed);
      else if (rState && stream.req && stream.aborted) process2.nextTick(onclosed);
      let cleanup = () => {
        if (
          ((callback = nop),
      ...
      if (options.signal && !closed) {
        ...
        if (options.signal.aborted) process2.nextTick(abort);
        else {
          addAbortListener2 = addAbortListener2 || require_util().addAbortListener;
          let disposable = addAbortListener2(options.signal, abort),
    ...
    function eosWeb(stream, options, callback) {
      ...
      let resolverFn = (...args) => {
        if (!isAborted) process2.nextTick(() => callback.apply(stream, args));
      };
  ...
  var require_destroy = __commonJS2((exports2, module2) => {
    var process2 = require_process(),
      ...
      { Symbol: Symbol2 } = require_primordials(),
      { kIsDestroyed, isDestroyed, isFinished, isServerRequest } = require_utils(),
      kDestroy = Symbol2("kDestroy"),
      kConstruct = Symbol2("kConstruct");
    function checkError(err, w, r) {
      if (err) {
        if ((err.stack, w && !w.errored)) w.errored = err;
    ...
    function destroy(err, cb) {
      ...
      if ((checkError(err, w, r), w)) w.destroyed = true;
    ...
    function _destroy(self2, err, cb) {
      ...
      function onDestroy(err2) {
        ...
        if ((checkError(err2, w, r), w)) w.closed = true;
        if (r) r.closed = true;
        if (typeof cb === "function") cb(err2);
        if (err2) process2.nextTick(emitErrorCloseNT, self2, err2);
        else process2.nextTick(emitCloseNT, self2);
      }
      try {
    ...
    function errorOrDestroy(stream, err, sync) {
      ...
      if ((r !== null && r !== undefined && r.autoDestroy) || (w !== null && w !== undefined && w.autoDestroy))
        ...
        if ((err.stack, w && !w.errored)) w.errored = err;
        if (r && !r.errored) r.errored = err;
        if (sync) process2.nextTick(emitErrorNT, stream, err);
    ...
    function construct(stream, cb) {
      ...
      if ((stream.once(kConstruct, cb), stream.listenerCount(kConstruct) > 1)) return;
    ...
    function constructNT(stream) {
      ...
      function onConstruct(err) {
        ...
        else process2.nextTick(emitConstructNT, stream);
      }
      try {
    ...
    function isRequest(stream) {
      return (
        (stream === null || stream === undefined ? undefined : stream.setHeader) && typeof stream.abort === "function"
      );
    }
    ...
    function destroyer(stream, err) {
      ...
      if (!err && !isFinished(stream)) err = new AbortError2();
      if (isServerRequest(stream)) ((stream.socket = null), stream.destroy(err));
      ...
      else if (err) process2.nextTick(emitErrorCloseLegacy, stream, err);
      else process2.nextTick(emitCloseLegacy, stream);
  ...
  var require_legacy = __commonJS2((exports2, module2) => {
    var { ArrayIsArray, ObjectSetPrototypeOf } = require_primordials(),
      { EventEmitter: EE } = (init_events(), __toCommonJS(exports_events));
    ...
    Stream.prototype.pipe = function (dest, options) {
      ...
      function onclose() {
        if (didOnEnd) return;
        if (((didOnEnd = true), typeof dest.destroy === "function")) dest.destroy();
      }
      function onerror(er) {
        if ((cleanup(), EE.listenerCount(this, "error") === 0)) this.emit("error", er);
      }
  ...
  var require_add_abort_signal = __commonJS2((exports2, module2) => {
    var { SymbolDispose } = require_primordials(),
      { AbortError: AbortError2, codes } = require_errors(),
      { isNodeStream, isWebStream, kControllerErrorFunction } = require_utils(),
      eos = require_end_of_stream(),
      { ERR_INVALID_ARG_TYPE: ERR_INVALID_ARG_TYPE3 } = codes,
      addAbortListener2,
      validateAbortSignal2 = (signal, name) => {
  ...
  var require_buffer_list = __commonJS2((exports2, module2) => {
    var {
      ...
      { Buffer: Buffer3 } = (init_buffer(), __toCommonJS(exports_buffer)),
      { inspect } = require_util();
    module2.exports = class {
      ...
      concat(n) {
        ...
        let ret = Buffer3.allocUnsafe(n >>> 0),
          p = this.head,
          i2 = 0;
        while (p) (TypedArrayPrototypeSet(ret, p.data, i2), (i2 += p.data.length), (p = p.next));
        return ret;
      }
      ...
      *[SymbolIterator]() {
      ...
      _getString(n) {
        ...
        do {
          let str = p.data;
          if (n > str.length) ((ret += str), (n -= str.length));
          else {
            if (n === str.length)
              if (((ret += str), ++c, p.next)) this.head = p.next;
              else this.head = this.tail = null;
            else ((ret += StringPrototypeSlice(str, 0, n)), (this.head = p), (p.data = StringPrototypeSlice(str, n)));
            break;
          }
          ++c;
        } while ((p = p.next) !== null);
      ...
      _getBuffer(n) {
        let ret = Buffer3.allocUnsafe(n),
          retLen = n,
          p = this.head,
          c = 0;
        do {
          let buf = p.data;
          if (n > buf.length) (TypedArrayPrototypeSet(ret, buf, retLen - n), (n -= buf.length));
          else {
            if (n === buf.length)
              if ((TypedArrayPrototypeSet(ret, buf, retLen - n), ++c, p.next)) this.head = p.next;
              else this.head = this.tail = null;
            else
  ...
  var require_state = __commonJS2((exports2, module2) => {
    var { MathFloor, NumberIsInteger } = require_primordials(),
      { validateInteger } = require_validators(),
      { ERR_INVALID_ARG_VALUE } = require_errors().codes,
      defaultHighWaterMarkBytes = 16384,
      defaultHighWaterMarkObjectMode = 16;
    ...
    function setDefaultHighWaterMark(objectMode, value) {
      if ((validateInteger(value, "value", 0), objectMode)) defaultHighWaterMarkObjectMode = value;
  ...
  var require_safe_buffer = __commonJS2((exports2, module2) => {
    ...
    if (Buffer3.from && Buffer3.alloc && Buffer3.allocUnsafe && Buffer3.allocUnsafeSlow) module2.exports = buffer;
    else (copyProps(buffer, exports2), (exports2.Buffer = SafeBuffer));
  ...
  var require_string_decoder = __commonJS2((exports2) => {
    ...
    StringDecoder.prototype.write = function (buf) {
      ...
      var r, i2;
      if (this.lastNeed) {
        if (((r = this.fillLast(buf)), r === undefined)) return "";
    ...
    function utf8CheckExtraBytes(self2, buf, p) {
      if ((buf[0] & 192) !== 128) return ((self2.lastNeed = 0), "�");
      if (self2.lastNeed > 1 && buf.length > 1) {
        if ((buf[1] & 192) !== 128) return ((self2.lastNeed = 1), "�");
        if (self2.lastNeed > 2 && buf.length > 2) {
          if ((buf[2] & 192) !== 128) return ((self2.lastNeed = 2), "�");
        }
      }
    }
    ...
    function utf16Text(buf, i2) {
      ...
      return (
        ...
        buf.toString("utf16le", i2, buf.length - 1)
      );
    }
    ...
    function base64Text(buf, i2) {
      ...
      if (((this.lastNeed = 3 - n), (this.lastTotal = 3), n === 1)) this.lastChar[0] = buf[buf.length - 1];
  ...
  var require_from = __commonJS2((exports2, module2) => {
    var process2 = require_process(),
      { PromisePrototypeThen, SymbolAsyncIterator, SymbolIterator } = require_primordials(),
      { Buffer: Buffer3 } = (init_buffer(), __toCommonJS(exports_buffer)),
      { ERR_INVALID_ARG_TYPE: ERR_INVALID_ARG_TYPE3, ERR_STREAM_NULL_VALUES } = require_errors().codes;
    function from2(Readable, iterable, opts) {
      ...
      let isAsync;
      if (iterable && iterable[SymbolAsyncIterator]) ((isAsync = true), (iterator = iterable[SymbolAsyncIterator]()));
      else if (iterable && iterable[SymbolIterator]) ((isAsync = false), (iterator = iterable[SymbolIterator]()));
      else throw new ERR_INVALID_ARG_TYPE3("iterable", ["Iterable"], iterable);
      let readable = new Readable({ objectMode: true, highWaterMark: 1, ...opts }),
        reading = false;
      ((readable._read = function () {
        if (!reading) ((reading = true), next());
      }),
        ...
        for (;;) {
          try {
            ...
            if (done) readable.push(null);
              ...
              if (res === null) throw ((reading = false), new ERR_STREAM_NULL_VALUES());
  ...
  var require_readable = __commonJS2((exports2, module2) => {
    ...
    var { EventEmitter: EE } = (init_events(), __toCommonJS(exports_events)),
      { Stream, prependListener } = require_legacy(),
      { Buffer: Buffer3 } = (init_buffer(), __toCommonJS(exports_buffer)),
      { addAbortSignal } = require_add_abort_signal(),
      eos = require_end_of_stream(),
      debug = require_util().debuglog("stream", (fn) => {
        debug = fn;
      }),
      BufferList = require_buffer_list(),
      destroyImpl = require_destroy(),
      { getHighWaterMark, getDefaultHighWaterMark } = require_state(),
      {
        aggregateTwoErrors,
        codes: {
          ERR_INVALID_ARG_TYPE: ERR_INVALID_ARG_TYPE3,
      ...
      { validateObject } = require_validators(),
      kPaused = Symbol2("kPaused"),
      { StringDecoder } = require_string_decoder(),
      from2 = require_from();
    ...
    var nop = () => {},
      ...
      kSync = 32,
      kNeedReadable = 64,
      kEmittedReadable = 128,
      kReadableListening = 256,
      kResumeScheduled = 512,
      kErrorEmitted = 1024,
      kEmitClose = 2048,
      kAutoDestroy = 4096,
      kDestroyed = 8192,
    ...
    function ReadableState(options, stream, isDuplex) {
      ...
      if (
        ...
        (this.flowing = null),
        (this[kPaused] = null),
        options && options.emitClose === false)
      )
    ...
    Readable.prototype[SymbolAsyncDispose] = function () {
      let error;
      if (!this.destroyed) ((error = this.readableEnded ? null : new AbortError2()), this.destroy(error));
      return new Promise2((resolve, reject) =>
    ...
    function readableAddChunk(stream, chunk, encoding, addToFront) {
      ...
      if ((state.state & kObjectMode) === 0) {
        if (typeof chunk === "string") {
          if (((encoding = encoding || state.defaultEncoding), state.encoding !== encoding))
            if (addToFront && state.encoding) chunk = Buffer3.from(chunk, encoding).toString(state.encoding);
            else ((chunk = Buffer3.from(chunk, encoding)), (encoding = ""));
        } else if (chunk instanceof Buffer3) encoding = "";
        else if (Stream._isUint8Array(chunk)) ((chunk = Stream._uint8ArrayToBuffer(chunk)), (encoding = ""));
        else if (chunk != null) err = new ERR_INVALID_ARG_TYPE3("chunk", ["string", "Buffer", "Uint8Array"], chunk);
      }
      if (err) errorOrDestroy(stream, err);
      else if (chunk === null) ((state.state &= ~kReading), onEofChunk(stream, state));
      ...
      else if (!addToFront) ((state.state &= ~kReading), maybeReadMore(stream, state));
    ...
    function addChunk(stream, state, chunk, addToFront) {
      if (state.flowing && state.length === 0 && !state.sync && stream.listenerCount("data") > 0) {
        ...
        if (((state.length += state.objectMode ? 1 : chunk.length), addToFront)) state.buffer.unshift(chunk);
    ...
    Readable.prototype.setEncoding = function (enc) {
      ...
      let buffer = this._readableState.buffer,
        content = "";
      for (let data of buffer) content += decoder.write(data);
      if ((buffer.clear(), content !== "")) buffer.push(content);
      return ((this._readableState.length = content.length), this);
    };
    var MAX_HWM = 1073741824;
    function computeNewHighWaterMark(n) {
      if (n > MAX_HWM) throw new ERR_OUT_OF_RANGE3("size", "<= 1GiB", n);
    ...
    Readable.prototype.read = function (n) {
      if ((debug("read", n), n === undefined)) n = NaN;
      ...
      if (state.ended || state.reading || state.destroyed || state.errored || !state.constructed)
        ...
        if ((debug("do read"), (state.state |= kReading | kSync), state.length === 0)) state.state |= kNeedReadable;
        try {
          this._read(state.highWaterMark);
        } catch (err) {
          errorOrDestroy(this, err);
        }
        if (((state.state &= ~kSync), !state.reading)) n = howMuchToRead(nOrig, state);
      }
      let ret;
      if (n > 0) ret = fromList(n, state);
      else ret = null;
      if (ret === null) ((state.needReadable = state.length <= state.highWaterMark), (n = 0));
      else if (((state.length -= n), state.multiAwaitDrain)) state.awaitDrainWriters.clear();
      else state.awaitDrainWriters = null;
      if (state.length === 0) {
    ...
    function onEofChunk(stream, state) {
      ...
      if (state.decoder) {
        ...
        if (chunk && chunk.length) (state.buffer.push(chunk), (state.length += state.objectMode ? 1 : chunk.length));
      }
      if (((state.ended = true), state.sync)) emitReadable(stream);
      else ((state.needReadable = false), (state.emittedReadable = true), emitReadable_(stream));
    }
    ...
    function emitReadable_(stream) {
      ...
      if (
        ...
        !state.destroyed && !state.errored && (state.length || state.ended))
      )
    ...
    function maybeReadMore_(stream, state) {
      while (
        ...
        if ((debug("maybeReadMore read 0"), stream.read(0), len2 === state.length)) break;
      }
    ...
    Readable.prototype.pipe = function (dest, pipeOpts) {
      ...
      let endFn =
        (!pipeOpts || pipeOpts.end !== false) && dest !== process2.stdout && dest !== process2.stderr ? onend : unpipe;
      if (state.endEmitted) process2.nextTick(endFn);
      else src.once("end", endFn);
      dest.on("unpipe", onunpipe);
      function onunpipe(readable, unpipeInfo) {
        if ((debug("onunpipe"), readable === src)) {
          if (unpipeInfo && unpipeInfo.hasUnpiped === false) ((unpipeInfo.hasUnpiped = true), cleanup());
        }
      }
      function onend() {
      ...
      function cleanup() {
        ...
        if (
          ...
          (cleanedUp = true),
          ondrain && state.awaitDrainWriters && (!dest._writableState || dest._writableState.needDrain))
        )
          ondrain();
      }
      function pause() {
        ...
        if (!ondrain) ((ondrain = pipeOnDrain(src, dest)), dest.on("drain", ondrain));
      }
      src.on("data", ondata);
      function ondata(chunk) {
        debug("ondata");
        let ret = dest.write(chunk);
        if ((debug("dest.write", ret), ret === false)) pause();
      }
      function onerror(er) {
        if (
          (debug("onerror", er), unpipe(), dest.removeListener("error", onerror), dest.listenerCount("error") === 0)
        ) {
      ...
      if ((dest.emit("pipe", src), dest.writableNeedDrain === true)) pause();
      else if (!state.flowing) (debug("pipe resume"), src.resume());
      return dest;
    };
    function pipeOnDrain(src, dest) {
      return function () {
        let state = src._readableState;
        if (state.awaitDrainWriters === dest) (debug("pipeOnDrain", 1), (state.awaitDrainWriters = null));
    ...
    Readable.prototype.unpipe = function (dest) {
      ...
      if (!dest) {
        ...
        for (let i2 = 0; i2 < dests.length; i2++) dests[i2].emit("unpipe", this, { hasUnpiped: false });
        return this;
      }
      let index = ArrayPrototypeIndexOf(state.pipes, dest);
      if (index === -1) return this;
      if ((state.pipes.splice(index, 1), state.pipes.length === 0)) this.pause();
      return (dest.emit("unpipe", this, unpipeInfo), this);
    };
    Readable.prototype.on = function (ev, fn) {
      let res = Stream.prototype.on.call(this, ev, fn),
        state = this._readableState;
      if (ev === "data") {
        if (((state.readableListening = this.listenerCount("readable") > 0), state.flowing !== false)) this.resume();
      } else if (ev === "readable") {
        if (!state.endEmitted && !state.readableListening) {
          if (
            ...
            emitReadable(this);
          else if (!state.reading) process2.nextTick(nReadingNextTick, this);
        }
      }
      return res;
    };
    ...
    Readable.prototype.removeListener = function (ev, fn) {
      ...
      if (ev === "readable") process2.nextTick(updateReadableListening, this);
      return res;
    };
    Readable.prototype.off = Readable.prototype.removeListener;
    Readable.prototype.removeAllListeners = function (ev) {
      let res = Stream.prototype.removeAllListeners.apply(this, arguments);
      if (ev === "readable" || ev === undefined) process2.nextTick(updateReadableListening, this);
      return res;
    };
    function updateReadableListening(self2) {
      ...
      if (
        ...
        state.resumeScheduled && state[kPaused] === false)
      )
        state.flowing = true;
    ...
    Readable.prototype.resume = function () {
      let state = this._readableState;
      if (!state.flowing) (debug("resume"), (state.flowing = !state.readableListening), resume(this, state));
      return ((state[kPaused] = false), this);
    };
    function resume(stream, state) {
      if (!state.resumeScheduled) ((state.resumeScheduled = true), process2.nextTick(resume_, stream, state));
    }
    function resume_(stream, state) {
      if ((debug("resume", state.reading), !state.reading)) stream.read(0);
    ...
    Readable.prototype.wrap = function (stream) {
      ...
      (stream.on("data", (chunk) => {
        if (!this.push(chunk) && stream.pause) ((paused = true), stream.pause());
      }),
        stream.on("end", () => {
          this.push(null);
        }),
        ...
        (this._read = () => {
          if (paused && stream.resume) ((paused = false), stream.resume());
        }));
      let streamKeys = ObjectKeys(stream);
      for (let j = 1; j < streamKeys.length; j++) {
        let i2 = streamKeys[j];
        if (this[i2] === undefined && typeof stream[i2] === "function") this[i2] = stream[i2].bind(stream);
      }
      return this;
    };
    ...
    async function* createAsyncIterator(stream, options) {
      ...
      try {
        ...
        else (stream.off("readable", next), cleanup());
      }
    }
    ...
    function endReadableNT(state, stream) {
      if (
        ...
        !state.errored && !state.closeEmitted && !state.endEmitted && state.length === 0)
      ) {
  ...
  var require_writable = __commonJS2((exports2, module2) => {
    ...
    function _write(stream, chunk, encoding, cb) {
      ...
      if (typeof encoding === "function") ((cb = encoding), (encoding = state.defaultEncoding));
      else {
      ...
      if (chunk === null) throw new ERR_STREAM_NULL_VALUES();
        ...
        if (typeof chunk === "string") {
          if (state.decodeStrings !== false) ((chunk = Buffer3.from(chunk, encoding)), (encoding = "buffer"));
        } else if (chunk instanceof Buffer3) encoding = "buffer";
        else if (Stream._isUint8Array(chunk)) ((chunk = Stream._uint8ArrayToBuffer(chunk)), (encoding = "buffer"));
        else throw new ERR_INVALID_ARG_TYPE3("chunk", ["string", "Buffer", "Uint8Array"], chunk);
      let err;
      if (state.ending) err = new ERR_STREAM_WRITE_AFTER_END();
      else if (state.destroyed) err = new ERR_STREAM_DESTROYED("write");
      if (err) return (process2.nextTick(cb, err), errorOrDestroy(stream, err, true), err);
    ...
    Writable.prototype.uncork = function () {
      let state = this._writableState;
      if (state.corked) {
        if ((state.corked--, !state.writing)) clearBuffer(this, state);
      }
    };
    ...
    function onwrite(stream, er) {
      ...
      if (
        ((state.writing = false), (state.writecb = null), (state.length -= state.writelen), (state.writelen = 0), er)
      ) {
        if ((er.stack, !state.errored)) state.errored = er;
        if (stream._readableState && !stream._readableState.errored) stream._readableState.errored = er;
        if (sync) process2.nextTick(onwriteError, stream, state, er, cb);
    ...
    function errorBuffer(state) {
      ...
      for (let n = state.bufferedIndex; n < state.buffered.length; ++n) {
        var _state$errored;
        let { chunk, callback } = state.buffered[n],
          len2 = state.objectMode ? 1 : chunk.length;
        ((state.length -= len2),
          callback(
    ...
    function clearBuffer(stream, state) {
      ...
      let { buffered, bufferedIndex, objectMode } = state,
        bufferedLength = buffered.length - bufferedIndex;
      if (!bufferedLength) return;
      let i2 = bufferedIndex;
      if (((state.bufferProcessing = true), bufferedLength > 1 && stream._writev)) {
        state.pendingcb -= bufferedLength - 1;
        let callback = state.allNoop
            ? nop
            : (err) => {
                for (let n = i2; n < buffered.length; ++n) buffered[n].callback(err);
              },
        ...
        if (i2 === buffered.length) resetBuffer(state);
        else if (i2 > 256) (buffered.splice(0, i2), (state.bufferedIndex = 0));
        else state.bufferedIndex = i2;
      }
    ...
    Writable.prototype.end = function (chunk, encoding, cb) {
      ...
      if (chunk !== null && chunk !== undefined) {
        ...
        if (ret instanceof Error2) err = ret;
      }
      ...
      if (typeof cb === "function")
        if (err || state.finished) process2.nextTick(cb, err);
    ...
    function callFinal(stream, state) {
      ...
      function onFinish(err) {
        ...
        if (((called = true), state.pendingcb--, err)) {
          let onfinishCallbacks = state[kOnFinished].splice(0);
          for (let i2 = 0; i2 < onfinishCallbacks.length; i2++) onfinishCallbacks[i2](err);
    ...
    function prefinish(stream, state) {
      if (!state.prefinished && !state.finalCalled)
        ...
        else ((state.prefinished = true), stream.emit("prefinish"));
    }
        ...
        if ((prefinish(stream, state), state.pendingcb === 0)) {
          if (sync)
            (state.pendingcb++,
              process2.nextTick(
                (stream2, state2) => {
                  if (needFinish(state2)) finish(stream2, state2);
                  else state2.pendingcb--;
                },
                stream,
                state,
              ));
          else if (needFinish(state)) (state.pendingcb++, finish(stream, state));
        }
      }
    }
    function finish(stream, state) {
      ...
      let onfinishCallbacks = state[kOnFinished].splice(0);
      for (let i2 = 0; i2 < onfinishCallbacks.length; i2++) onfinishCallbacks[i2]();
  ...
  var require_duplexify = __commonJS2((exports2, module2) => {
    var process2 = require_process(),
      bufferModule = (init_buffer(), __toCommonJS(exports_buffer)),
      {
        isReadable,
        isWritable,
        isIterable,
      ...
      { destroyer } = require_destroy(),
      Duplex = require_duplex(),
      Readable = require_readable(),
      Writable = require_writable(),
      { createDeferredPromise } = require_util(),
      from2 = require_from(),
      Blob3 = globalThis.Blob || bufferModule.Blob,
      isBlob =
        typeof Blob3 < "u"
    ...
    module2.exports = function duplexify(body, name) {
      ...
      if (isNodeStream(body)) return _duplexify({ writable: false, readable: false });
      ...
      if (typeof body === "function") {
        ...
        if (isIterable(value)) return from2(Duplexify, value, { objectMode: true, write: write2, final, destroy });
        let then2 = value === null || value === undefined ? undefined : value.then;
        if (typeof then2 === "function") {
          let d,
            promise = FunctionPrototypeCall(
              then2,
              value,
              (val) => {
      ...
      if (isIterable(body)) return from2(Duplexify, body, { objectMode: true, writable: false });
      if (
        ...
        value: fn(
          (async function* () {
            while (true) {
              ...
              if ((process2.nextTick(cb), done)) return;
              if (signal.aborted) throw new AbortError2(undefined, { cause: signal.reason });
    ...
    function _duplexify(pair) {
      let r = pair.readable && typeof pair.readable.read !== "function" ? Readable.wrap(pair.readable) : pair.readable,
        w = pair.writable,
        readable = !!isReadable(r),
        writable = !!isWritable(w),
        ondrain,
        onfinish,
        onreadable,
        onclose,
      ...
      if (
        ...
        (eos(w, (err) => {
          if (((writable = false), err)) destroyer(r, err);
          onfinished(err);
        }),
      ...
      if (readable)
        (eos(r, (err) => {
          if (((readable = false), err)) destroyer(r, err);
          onfinished(err);
        }),
      ...
      return (
        (d._destroy = function (err, callback) {
          if (!err && onclose !== null) err = new AbortError2();
          if (((onreadable = null), (ondrain = null), (onfinish = null), onclose === null)) callback(err);
  ...
  var require_transform = __commonJS2((exports2, module2) => {
    ...
    var { ERR_METHOD_NOT_IMPLEMENTED } = require_errors().codes,
      Duplex = require_duplex(),
      { getHighWaterMark } = require_state();
    ...
    function final(cb) {
      if (typeof this._flush === "function" && !this.destroyed)
        this._flush((er, data) => {
          ...
          if ((this.push(null), cb)) cb();
        });
      else if ((this.push(null), cb)) cb();
    }
    function prefinish() {
    ...
    Transform.prototype._write = function (chunk, encoding, callback) {
      let rState = this._readableState,
        wState = this._writableState,
  ...
  var require_pipeline = __commonJS2((exports2, module2) => {
    var process2 = require_process(),
      { ArrayIsArray, Promise: Promise2, SymbolAsyncIterator, SymbolDispose } = require_primordials(),
      eos = require_end_of_stream(),
      { once } = require_util(),
      destroyImpl = require_destroy(),
      Duplex = require_duplex(),
      ...
      { validateFunction, validateAbortSignal: validateAbortSignal2 } = require_validators(),
      {
        isIterable,
        isReadable,
        isReadableNodeStream,
    ...
    async function pumpToNode(iterable, writable, finish, { end }) {
      ...
      try {
        ...
        for await (let chunk of iterable) if (!writable.write(chunk)) await wait();
        if (end) (writable.end(), await wait());
        finish();
      } catch (err) {
    ...
    async function pumpToWeb(readable, writable, finish, { end }) {
      ...
      try {
        for await (let chunk of readable) (await writer.ready, writer.write(chunk).catch(() => {}));
        if ((await writer.ready, end)) await writer.close();
        finish();
      } catch (err) {
        try {
    ...
    function pipelineImpl(streams, callback, opts) {
      ...
      let ac = new AbortController2(),
        signal = ac.signal,
        outerSignal = opts === null || opts === undefined ? undefined : opts.signal,
        lastStreamCleanup = [];
      ...
      addAbortListener2 = addAbortListener2 || require_util().addAbortListener;
      let disposable;
      if (outerSignal) disposable = addAbortListener2(outerSignal, abort);
      let error,
        value,
        destroys = [],
        finishCount = 0;
      ...
      for (let i2 = 0; i2 < streams.length; i2++) {
        let stream = streams[i2],
          reading = i2 < streams.length - 1,
          writing = i2 > 0,
          end = reading || (opts === null || opts === undefined ? undefined : opts.end) !== false,
          isLastStream = i2 === streams.length - 1;
        if (isNodeStream(stream)) {
          ...
          if (end) {
            ...
            if ((destroys.push(destroy), isReadable(stream) && isLastStream)) lastStreamCleanup.push(cleanup);
          }
        ...
        if (i2 === 0)
          ...
          if (((ret = stream(ret, { signal })), reading)) {
            ...
            let pt = new PassThrough({ objectMode: true }),
              then = (_ret2 = ret) === null || _ret2 === undefined ? undefined : _ret2.then;
            if (typeof then === "function")
              (finishCount++,
                then.call(
                  ret,
                  (val) => {
                    if (((value = val), val != null)) pt.write(val);
                    if (end) pt.end();
            ...
            else if (isIterable(ret, true)) (finishCount++, pumpToNode(ret, pt, finish, { end }));
            ...
            if ((destroys.push(destroy), isLastStream)) lastStreamCleanup.push(cleanup);
          }
          ...
          } else if (isIterable(ret)) (finishCount++, pumpToNode(ret, stream, finish, { end }));
          else
            throw new ERR_INVALID_ARG_TYPE3(
              "val",
          ...
          if (isReadableNodeStream(ret)) (finishCount++, pumpToWeb(makeAsyncIterable(ret), stream, finish, { end }));
          else if (isReadableStream(ret) || isIterable(ret)) (finishCount++, pumpToWeb(ret, stream, finish, { end }));
          else if (isTransformStream(ret)) (finishCount++, pumpToWeb(ret.readable, stream, finish, { end }));
          else
            throw new ERR_INVALID_ARG_TYPE3(
              "val",
              ["Readable", "Iterable", "AsyncIterable", "ReadableStream", "TransformStream"],
    ...
    function pipe(src, dst, finish, { end }) {
      ...
      if (
        ...
        var endFn = endFn2;
        if (isReadableFinished(src)) process2.nextTick(endFn2);
        else src.once("end", endFn2);
      } else finish();
      return (
  ...
  var require_compose = __commonJS2((exports2, module2) => {
    var { pipeline } = require_pipeline(),
      Duplex = require_duplex(),
      { destroyer } = require_destroy(),
      { isNodeStream, isReadable, isWritable, isWebStream, isTransformStream, isWritableStream, isReadableStream } =
        require_utils(),
      {
        AbortError: AbortError2,
    ...
    module2.exports = function (...streams) {
      ...
      let head = streams[0],
        tail = pipeline(streams, onfinished),
        writable = !!(isWritable(head) || isWritableStream(head) || isTransformStream(head)),
        readable = !!(isReadable(tail) || isReadableStream(tail) || isTransformStream(tail));
      if (
        ((d = new Duplex({
      ...
      return (
        (d._destroy = function (err, callback) {
          if (!err && onclose !== null) err = new AbortError2();
          if (((onreadable = null), (ondrain = null), (onfinish = null), onclose === null)) callback(err);
          else if (((onclose = callback), isNodeStream(tail))) destroyer(tail, err);
        }),
        d
      );
    };
  ...
  var require_operators = __commonJS2((exports2, module2) => {
    var AbortController2 = globalThis.AbortController || require_abort_controller().AbortController,
      ...
      { validateAbortSignal: validateAbortSignal2, validateInteger, validateObject } = require_validators(),
      kWeakHandler = require_primordials().Symbol("kWeak"),
      kResistStopPropagation = require_primordials().Symbol("kResistStopPropagation"),
      { finished } = require_end_of_stream(),
      staticCompose = require_compose(),
      { addAbortSignalNoValidate } = require_add_abort_signal(),
      { isWritable, isNodeStream } = require_utils(),
      { deprecate } = require_util(),
      {
        ArrayPrototypePush,
        Boolean: Boolean2,
        MathFloor,
    ...
    function map(fn, options) {
      if (typeof fn !== "function") throw new ERR_INVALID_ARG_TYPE3("fn", ["Function", "AsyncFunction"], fn);
      if (options != null) validateObject(options, "options");
      if ((options === null || options === undefined ? undefined : options.signal) != null)
        validateAbortSignal2(options.signal, "options.signal");
      let concurrency = 1;
      ...
      return (
        ...
        async function* () {
          let signal = require_util().AbortSignalAny(
              [options === null || options === undefined ? undefined : options.signal].filter(Boolean2),
            ),
            stream = this,
            queue = [],
            signalOpt = { signal },
          ...
          function maybeResume() {
            if (resume && !done && cnt < concurrency && queue.length < highWaterMark) (resume(), (resume = null));
          }
          async function pump() {
            try {
              for await (let val of stream) {
                ...
                try {
                  if (((val = fn(val, signalOpt)), val === kEmpty)) continue;
              ...
              if (((done = true), next)) (next(), (next = null));
            }
          }
          pump();
          try {
            ...
            if (((done = true), resume)) (resume(), (resume = null));
          }
        }.call(this)
      );
    }
    ...
    async function some(fn, options = undefined) {
      for await (let unused of filter.call(this, fn, options)) return true;
      return false;
    }
    ...
    async function find(fn, options) {
      for await (let result of filter.call(this, fn, options)) return result;
      return;
    }
    ...
    function filter(fn, options) {
      ...
      async function filterFn(value, options2) {
        if (await fn(value, options2)) return value;
        return kEmpty;
      }
    ...
    async function reduce(reducer, initialValue, options) {
      ...
      try {
        for await (let value of this) {
          ...
          if (!hasInitialValue) ((initialValue = value), (hasInitialValue = true));
    ...
    function flatMap(fn, options) {
      ...
      return async function* () {
        for await (let val of values) yield* val;
      }.call(this);
    }
    function toIntegerOrInfinity(number) {
      if (((number = Number2(number)), NumberIsNaN(number))) return 0;
      if (number < 0) throw new ERR_OUT_OF_RANGE3("number", ">= 0", number);
      return number;
    }
  ...
  var require_promises = __commonJS2((exports2, module2) => {
    var { ArrayPrototypePop, Promise: Promise2 } = require_primordials(),
      { isIterable, isNodeStream, isWebStream } = require_utils(),
      { pipelineImpl: pl } = require_pipeline(),
      { finished } = require_end_of_stream();
    require_stream2();
    function pipeline(...streams) {
      return new Promise2((resolve, reject) => {
  ...
  var require_stream2 = __commonJS2((exports2, module2) => {
    var { Buffer: Buffer3 } = (init_buffer(), __toCommonJS(exports_buffer)),
      { ObjectDefineProperty, ObjectKeys, ReflectApply } = require_primordials(),
      {
        promisify: { custom: customPromisify },
      } = require_util(),
      { streamReturningOperators, promiseReturningOperators } = require_operators(),
      {
        codes: { ERR_ILLEGAL_CONSTRUCTOR },
      } = require_errors(),
      compose = require_compose(),
      { setDefaultHighWaterMark, getDefaultHighWaterMark } = require_state(),
      { pipeline } = require_pipeline(),
      { destroyer } = require_destroy(),
      eos = require_end_of_stream(),
      promises = require_promises(),
      utils = require_utils(),
      Stream = (module2.exports = require_legacy().Stream);
  ...
  var require_ours = __commonJS2((exports2, module2) => {
    ...
    {
      let CustomStream = require_stream2(),
        promises = require_promises(),
        originalDestroy = CustomStream.Readable.destroy;
...
var require_xml2js = __commonJS((exports, module) => {
  ...
  function manipulateAttributes(attributes) {
    ...
    if (
      (options.trim || "attributeValueFn" in options || "attributeNameFn" in options || options.nativeTypeAttributes) &&
      attributes
    ) {
      var key;
...
`
  ...
  function writeAttributes(attributes, options, depth) {
    ...
    for (key in attributes) {
      if (attributes.hasOwnProperty(key) && attributes[key] !== null && attributes[key] !== undefined) {
        ...
        attr = attr.replace(/"/g, "&quot;");
        attrName =
          "attributeNameFn" in options ? options.attributeNameFn(key, attr, currentElementName, currentElement) : key;
        ...
        result.push(
          attrName +
            ...
            ("attributeValueFn" in options
              ? options.attributeValueFn(attr, key, currentElementName, currentElement)
              : attr) +
            quote,
        );
      }
  ...
  function writeDeclaration(declaration, options, depth) {
    ...
    return options.ignoreDeclaration
      ? ""
      : "<?" + "xml" + writeAttributes(declaration[options.attributesKey], options, depth) + "?>";
  }
  function writeInstruction(instruction, options, depth) {
    ...
    var instructionName =
      "instructionNameFn" in options
        ? options.instructionNameFn(key, instruction[key], currentElementName, currentElement)
        : key;
  ...
  function writeComment(comment, options) {
    return options.ignoreComment
      ? ""
      : "<!--" +
          ("commentFn" in options ? options.commentFn(comment, currentElementName, currentElement) : comment) +
          "-->";
  }
  ...
  function writeDoctype(doctype, options) {
    return options.ignoreDoctype
      ? ""
      : "<!DOCTYPE " +
          ("doctypeFn" in options ? options.doctypeFn(doctype, currentElementName, currentElement) : doctype) +
          ">";
  }
  ...
  function writeElement(element, options, depth) {
    ...
    var withClosingTag =
      ...
      (element[options.attributesKey] && element[options.attributesKey]["xml:space"] === "preserve");
    if (!withClosingTag) {
...
` + Array(depth + 1).join(options.spaces)
  ...
  function writeElementCompact(element, name, options, depth, indent) {
    ...
    if (typeof element === "undefined" || element === null || element === "") {
      return ("fullTagEmptyElementFn" in options && options.fullTagEmptyElementFn(name, element)) ||
      ...
      if (element.hasOwnProperty(key)) {
        ...
        for (i2 = 0; i2 < nodes.length; ++i2) {
          switch (key) {
            ...
            case options.instructionKey:
              xml.push(
                (options.indentInstruction ? writeIndentation(options, depth, firstLine) : "") +
                  writeInstruction(nodes[i2], options, depth),
              );
              break;
            case options.attributesKey:
            case options.parentKey:
            ...
            case options.textKey:
              xml.push(
                (options.indentText ? writeIndentation(options, depth, firstLine) : "") + writeText(nodes[i2], options),
              );
              break;
            case options.cdataKey:
              xml.push(
                (options.indentCdata ? writeIndentation(options, depth, firstLine) : "") +
                  writeCdata(nodes[i2], options),
              );
              break;
            case options.doctypeKey:
            ...
            default:
              xml.push(
                writeIndentation(options, depth, firstLine) +
                  writeElementCompact(nodes[i2], key, options, depth, hasContentCompact(nodes[i2], options)),
              );
          }
  ...
  (function (root) {
    ...
    var encode = function (input) {
      ...
      if (padding == 2) {
        ...
        buffer = a + b;
        output +=
          TABLE.charAt(buffer >> 10) + TABLE.charAt((buffer >> 4) & 63) + TABLE.charAt((buffer << 2) & 63) + "=";
      } else if (padding == 1) {
...
class EmailTools {
  ...
  async sendEmail(options) {
    const accountId = await this.client.getAccountId();
    const identityResponse = await this.client.call([["Identity/get", { accountId }, "a"]]);
...
var davRequest = async (params) => {
  ...
  if (
    !davResponse.ok ||
    !((_a = davResponse.headers.get("content-type")) === null || _a === undefined ? undefined : _a.includes("xml")) ||
    !parseOutgoing
  ) {
    return [
      {
  ...
  return responseBodies.map((responseBody) => {
    ...
    return {
      ...
      status: (matchArr === null || matchArr === undefined ? undefined : matchArr.groups)
        ? Number.parseInt(matchArr === null || matchArr === undefined ? undefined : matchArr.groups.status, 10)
        : davResponse.status,
      statusText:
        (_b =
          (_a2 = matchArr === null || matchArr === undefined ? undefined : matchArr.groups) === null ||
          _a2 === undefined
            ? undefined
            : _a2.statusText) !== null && _b !== undefined
          ? _b
          : davResponse.statusText,
      ok: !responseBody.error,
      error: responseBody.error,
      responsedescription: responseBody.responsedescription,
      props: (Array.isArray(responseBody.propstat) ? responseBody.propstat : [responseBody.propstat]).reduce(
        (prev, curr) => {
          return {
            ...prev,
...
var findMissingFieldNames = (obj, fields) =>
  fields.reduce((prev, curr) => (obj[curr] ? prev : `${prev.length ? `${prev},` : ""}${curr.toString()}`), "");
...
var supportedReportSet = async (params) => {
  ...
  return (_e =
    (_d =
      (_c =
        (_b = (_a = res[0]) === null || _a === undefined ? undefined : _a.props) === null || _b === undefined
          ? undefined
          : _b.supportedReportSet) === null || _c === undefined
        ? undefined
        : _c.supportedReport) === null || _d === undefined
      ? undefined
      : _d.map((sr) => Object.keys(sr.report)[0])) !== null && _e !== undefined
    ? _e
    : [];
};
var isCollectionDirty = async (params) => {
  ...
  return {
    ...
    newCtag:
      (_c = (_b = res.props) === null || _b === undefined ? undefined : _b.getctag) === null || _c === undefined
        ? undefined
        : _c.toString(),
  };
};
...
var smartCollectionSync = async (params) => {
  ...
  const syncMethod =
    method !== null && method !== undefined
      ? method
      : ((_a = collection.reports) === null || _a === undefined ? undefined : _a.includes("syncCollection"))
        ? "webdav"
        : "basic";
  ...
  if (syncMethod === "webdav") {
    ...
    const multiGetObjectResponse = changedObjectUrls.length
      ? (_c = await ((_b = collection === null || collection === undefined ? undefined : collection.objectMultiGet) ===
          null || _b === undefined
          ? undefined
          : _b.call(collection, {
              url: collection.url,
    ...
    const remoteObjects = multiGetObjectResponse.map((res) => {
      ...
      return {
        ...
        data:
          (account === null || account === undefined ? undefined : account.accountType) === "caldav"
            ? (_e2 =
                (_d2 = (_c2 = res.props) === null || _c2 === undefined ? undefined : _c2.calendarData) === null ||
                _d2 === undefined
                  ? undefined
                  : _d2._cdata) !== null && _e2 !== undefined
              ? _e2
              : (_f2 = res.props) === null || _f2 === undefined
                ? undefined
                : _f2.calendarData
            : (_j2 =
                  (_h2 = (_g2 = res.props) === null || _g2 === undefined ? undefined : _g2.addressData) === null ||
                  _h2 === undefined
                    ? undefined
                    : _h2._cdata) !== null && _j2 !== undefined
              ? _j2
              : (_k2 = res.props) === null || _k2 === undefined
                ? undefined
                : _k2.addressData,
      };
    });
    ...
    return {
      ...
      syncToken:
        (_h =
          (_g =
            (_f = (_e = result[0]) === null || _e === undefined ? undefined : _e.raw) === null || _f === undefined
              ? undefined
              : _f.multistatus) === null || _g === undefined
            ? undefined
            : _g.syncToken) !== null && _h !== undefined
          ? _h
  ...
  if (syncMethod === "basic") {
    ...
    const remoteObjects =
      (_l = await ((_k = collection.fetchObjects) === null || _k === undefined
        ? undefined
        : _k.call(collection, {
            collection,
            headers: excludeHeaders(headers, headersToExclude),
...
var fetchAddressBooks = async (params) => {
  ...
  const res = await propfind({
    url: account.homeUrl,
    props:
      customProps !== null && customProps !== undefined
        ? customProps
        : {
            [`${DAVNamespaceShort.DAV}:displayname`]: {},
            [`${DAVNamespaceShort.CALENDAR_SERVER}:getctag`]: {},
  ...
  return Promise.all(
    res
      .filter((r) => {
        var _a, _b;
        return Object.keys(
          (_b = (_a = r.props) === null || _a === undefined ? undefined : _a.resourcetype) !== null && _b !== undefined
            ? _b
            : {},
      ...
      .map((rs) => {
        ...
        const displayName =
          (_c =
            (_b = (_a = rs.props) === null || _a === undefined ? undefined : _a.displayname) === null ||
            _b === undefined
              ? undefined
              : _b._cdata) !== null && _c !== undefined
            ? _c
            : (_d = rs.props) === null || _d === undefined
              ? undefined
              : _d.displayname;
        ...
        return {
          url: new URL(
            (_e = rs.href) !== null && _e !== undefined ? _e : "",
            (_f = account.rootUrl) !== null && _f !== undefined ? _f : "",
          ).href,
...
var fetchVCards = async (params) => {
  ...
  const vcardUrls = (
    objectUrls !== null && objectUrls !== undefined
      ? objectUrls
      : (
  ...
  return vCardResults.map((res) => {
    ...
    return {
      ...
      data:
        (_e =
          (_d = (_c = res.props) === null || _c === undefined ? undefined : _c.addressData) === null || _d === undefined
            ? undefined
            : _d._cdata) !== null && _e !== undefined
          ? _e
          : (_f = res.props) === null || _f === undefined
            ? undefined
            : _f.addressData,
    };
  });
...
var fetchCalendarUserAddresses = async (params) => {
  ...
  const addresses =
    ((_c =
      (_b =
        (_a = matched === null || matched === undefined ? undefined : matched.props) === null || _a === undefined
          ? undefined
          : _a.calendarUserAddressSet) === null || _b === undefined
        ? undefined
        : _b.href) === null || _c === undefined
      ? undefined
      : _c.filter(Boolean)) || [];
    ...
    res
      ...
      .filter((rc) => {
        ...
        const components = Array.isArray(
          (_b = (_a = rc.props) === null || _a === undefined ? undefined : _a.supportedCalendarComponentSet) === null ||
            _b === undefined
            ? undefined
            : _b.comp,
        )
          ? (_c = rc.props) === null || _c === undefined
            ? undefined
            : _c.supportedCalendarComponentSet.comp.map((sc) => sc._attributes.name)
          : [
              (_f =
                (_e = (_d = rc.props) === null || _d === undefined ? undefined : _d.supportedCalendarComponentSet) ===
                  null || _e === undefined
                  ? undefined
                  : _e.comp) === null || _f === undefined
                ? undefined
                : _f._attributes.name,
            ];
      ...
      .map((rs) => {
        ...
        return {
          ...
          url: new URL(
            (_c = rs.href) !== null && _c !== undefined ? _c : "",
            (_d = account.rootUrl) !== null && _d !== undefined ? _d : "",
          ).href,
          ...
          displayName:
            (_h = (_g = rs.props) === null || _g === undefined ? undefined : _g.displayname._cdata) !== null &&
            _h !== undefined
              ? _h
              : (_j = rs.props) === null || _j === undefined
                ? undefined
                : _j.displayname,
          components: Array.isArray(
            (_k = rs.props) === null || _k === undefined ? undefined : _k.supportedCalendarComponentSet.comp,
          )
            ? (_l = rs.props) === null || _l === undefined
              ? undefined
              : _l.supportedCalendarComponentSet.comp.map((sc) => sc._attributes.name)
            : [
                (_o =
                  (_m = rs.props) === null || _m === undefined ? undefined : _m.supportedCalendarComponentSet.comp) ===
                  null || _o === undefined
                  ? undefined
                  : _o._attributes.name,
              ],
          ...
          ...conditionalParam(
            "projectedProps",
            Object.fromEntries(
              Object.entries((_r = rs.props) !== null && _r !== undefined ? _r : {}).filter(([key]) =>
                projectedProps === null || projectedProps === undefined ? undefined : projectedProps[key],
              ),
            ),
          ),
        };
...
var fetchCalendarObjects = async (params) => {
  const {
    ...
    headers,
    expand,
    urlFilter = (url) => Boolean(url === null || url === undefined ? undefined : url.includes(".ics")),
    useMultiGet = true,
    headersToExclude,
    fetchOptions = {},
  } = params;
  ...
  if (!calendar || !hasFields(calendar, requiredFields)) {
    ...
    throw new Error(
      `calendar must have ${findMissingFieldNames(calendar, requiredFields)} before fetchCalendarObjects`,
    );
  }
  const filters =
    customFilters !== null && customFilters !== undefined
      ? customFilters
      : [
          {
            "comp-filter": {
  ...
  return calendarObjectResults.map((res) => {
    ...
    return {
      ...
      data:
        (_e =
          (_d = (_c = res.props) === null || _c === undefined ? undefined : _c.calendarData) === null ||
          _d === undefined
            ? undefined
            : _d._cdata) !== null && _e !== undefined
          ? _e
...
var syncCalendars = async (params) => {
  ...
  const localCalendars =
    (_a = oldCalendars !== null && oldCalendars !== undefined ? oldCalendars : account.calendars) !== null &&
    _a !== undefined
      ? _a
      : [];
  ...
  const updatedWithObjects = await Promise.all(
    updated.map(async (u) => {
...
var fetchPrincipalUrl = async (params) => {
  ...
  debug$1(
    `Fetched principal url ${(_b = (_a = response.props) === null || _a === undefined ? undefined : _a.currentUserPrincipal) === null || _b === undefined ? undefined : _b.href}`,
  );
  return new URL(
    (_e =
      (_d = (_c = response.props) === null || _c === undefined ? undefined : _c.currentUserPrincipal) === null ||
      _d === undefined
        ? undefined
        : _d.href) !== null && _e !== undefined
      ? _e
      : "",
    account.rootUrl,
  ).href;
...
var fetchHomeUrl = async (params) => {
  ...
  if (!matched || !matched.ok) {
    debug$1(
      `Fetch home url failed with status ${matched === null || matched === undefined ? undefined : matched.statusText} and error ${JSON.stringify(responses.map((r) => r.error))}`,
    );
  ...
  const result = new URL(
    account.accountType === "caldav"
      ? (_a = matched === null || matched === undefined ? undefined : matched.props) === null || _a === undefined
        ? undefined
        : _a.calendarHomeSet.href
      : (_b = matched === null || matched === undefined ? undefined : matched.props) === null || _b === undefined
        ? undefined
        : _b.addressbookHomeSet.href,
    account.rootUrl,
  ).href;
...
var fetchOauthTokens = async (credentials, fetchOptions) => {
  const requireFields = ["authorizationCode", "redirectUrl", "clientId", "clientSecret", "tokenUrl"];
...
var refreshAccessToken = async (credentials, fetchOptions) => {
  const requireFields = ["refreshToken", "clientId", "clientSecret", "tokenUrl"];
  if (!hasFields(credentials, requireFields)) {
    throw new Error(`Oauth credentials missing: ${findMissingFieldNames(credentials, requireFields)}`);
  }
  const param = new URLSearchParams({
...
var getOauthHeaders = async (credentials, fetchOptions) => {
  ...
  if (!credentials.refreshToken) {
    ...
    Date.now() > ((_a = credentials.expiration) !== null && _a !== undefined ? _a : 0)
  ) {
...
var createDAVClient = async (params) => {
  ...
  switch (authMethod) {
    ...
    case "Custom":
      authHeaders =
        (_a = await (authFunction === null || authFunction === undefined ? undefined : authFunction(credentials))) !==
          null && _a !== undefined
          ? _a
          : {};
      break;
...
class DAVClient {
  ...
  async login() {
    ...
    switch (this.authMethod) {
      ...
      case "Digest":
        ...
        break;
      case "Custom":
        this.authHeaders = await ((_a = this.authFunction) === null || _a === undefined
          ? undefined
          : _a.call(this, this.credentials));
        break;
      default:
        throw new Error("Invalid auth method");
    }
  ...
  async fetchCalendars(...params) {
    return defaultParam(fetchCalendars, {
      ...
      account: this.account,
      fetchOptions: this.fetchOptions,
    })(params === null || params === undefined ? undefined : params[0]);
  }
  ...
  async fetchCalendarObjects(...params) {
    return defaultParam(fetchCalendarObjects, { headers: this.authHeaders, fetchOptions: this.fetchOptions })(
      params[0],
    );
  }
  async createCalendarObject(...params) {
    return defaultParam(createCalendarObject, { headers: this.authHeaders, fetchOptions: this.fetchOptions })(
      params[0],
    );
  }
  async updateCalendarObject(...params) {
    return defaultParam(updateCalendarObject, { headers: this.authHeaders, fetchOptions: this.fetchOptions })(
      params[0],
    );
  }
  async deleteCalendarObject(...params) {
    return defaultParam(deleteCalendarObject, { headers: this.authHeaders, fetchOptions: this.fetchOptions })(
      params[0],
    );
  }
...
`;
    ...
    for (const reminder of alarmsToAdd) {
      ...
      icsData +=
        this.buildVAlarm(reminder, reminderId) +
        `
`;
    }
    ...
    if (calendarId) {
      ...
      calendar2 =
        calendars.find(
          (c) =>
            c.displayName &&
            !c.displayName.toLowerCase().includes("task") &&
            !c.displayName.toLowerCase().includes("default"),
        ) || calendars[0];
      if (!calendar2) throw new Error("No calendars found");
    }
  ...
  constructor(type, originalError) {
    const messages = {
      email: {
        ...
        suggestion:
          "Check your FASTMAIL_API_TOKEN environment variable. Generate a new token at Fastmail Settings → Privacy & Security → Integrations → API tokens",
      },
      calendar: {
        message: "Failed to authenticate with Fastmail calendar",
        suggestion:
          "Check your FASTMAIL_USERNAME and FASTMAIL_PASSWORD environment variables. Use an app password, not your main password. Generate at Fastmail Settings → Privacy & Security → Integrations → App passwords",
      },
    };
