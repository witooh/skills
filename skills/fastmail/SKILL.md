...
bun scripts/cli.ts list_emails '{"limit": 10}'

# Search for emails
bun scripts/cli.ts search_emails '{"query": "invoice"}'

# Get specific email content
bun scripts/cli.ts get_email '{"email_id": "xxx"}'

# Get email thread/conversation
bun scripts/cli.ts get_thread '{"email_id": "xxx"}'

# Bulk operations
bun scripts/cli.ts bulk_move_emails '{"email_ids": ["id1", "id2"], "target_mailbox_id": "archive"}'
bun scripts/cli.ts bulk_delete_emails '{"email_ids": ["id1", "id2", "id3"]}'
...
bun scripts/cli.ts respond_to_invitation '{"event_id": "xxx", "response": "accept"}'
```
